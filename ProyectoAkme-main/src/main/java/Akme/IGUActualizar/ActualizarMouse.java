...
public class ActualizarMouse extends JFrame{
    ...
    public ActualizarMouse(UserModel userModel, ProductController productController){
        add(Ventana);
        setSize(300,300);
        setTitle("Actualizar Mouse");
        ...
        enviarButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if( productController.updateMouse(id,brand, model,price)){
