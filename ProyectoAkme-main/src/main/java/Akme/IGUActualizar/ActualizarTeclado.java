...
public class ActualizarTeclado extends JFrame{
    ...
    public ActualizarTeclado(UserModel userModel, ProductController productController){
        add(Ventana);
        setSize(300,300);
        ...
        enviarButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                String language = textField6.getText();
                double price =Integer.parseInt(textField7.getText());
                if(productController.updateKeyboard(id,brand,model,language,price)){
