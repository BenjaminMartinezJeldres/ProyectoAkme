...
public class CrearTeclado extends JFrame {
    ...
    public CrearTeclado(UserModel userModel, ProductController productController){
        add(Ventana);
        setSize(300,300);
        ...
        enviarButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(productController.validarKeyboardG(id,brand, model,language,price)){
